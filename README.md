rtl_433 (librtl_433 application demo)
===========

this is a first application demo for librtl_433:

It is just the same command line frontend as today's rtl_433 application itself (so it should offer the same functionality)

Here's the original readme from merbanan/rtl_433:
